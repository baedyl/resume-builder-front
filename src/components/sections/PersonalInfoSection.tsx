  ...
  return (
    <>
      ...
      <div className="space-y-2">
        ...
        <input
          {...register('fullName')}
          className={`w-full p-3 sm:p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm sm:text-base ${errors.fullName ? 'border-red-500' : 'border-gray-300'}`}
          placeholder="Full Name"
        />
        {errors.fullName?.message && <p className="mt-1 text-xs sm:text-sm text-red-600">{String(errors.fullName.message)}</p>}
      </div>
      ...
      <div className="space-y-2">
        ...
        <input
          {...register('email')}
          className={`w-full p-3 sm:p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm sm:text-base ${errors.email ? 'border-red-500' : 'border-gray-300'}`}
          placeholder="Email"
        />
        {errors.email?.message && <p className="mt-1 text-xs sm:text-sm text-red-600">{String(errors.email.message)}</p>}
      </div>
