...
<div class="mb-12">
  ...
  <div class="bg-green-50 dark:bg-green-900/20 rounded-lg p-6">
    ...
    <ul class="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
      <li><strong>ATS Optimization:</strong> Built-in keyword analysis and formatting</li>
      <li><strong>Industry Templates:</strong> Pre-designed layouts for your specific field</li>
      <li><strong>Content Suggestions:</strong> AI-powered writing assistance</li>
      <li><strong>Real-time Feedback:</strong> Instant suggestions for improvement</li>
      <li><strong>Export Options:</strong> Multiple format support (PDF, Word, etc.)</li>
    </ul>
  </div>
</div>

<div class="mb-12">
  <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-6">Step-by-Step AI Resume Creation Process</h2>
...
<div class="mb-12">
  <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-6">AI-Powered Content Enhancement</h2>
