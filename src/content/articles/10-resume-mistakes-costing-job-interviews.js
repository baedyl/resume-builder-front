...
<div class="mb-12">
  ...
  <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 mb-6">
    ...
    <ul class="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
      <li>Lack of time to customize for each position</li>
      <li>Uncertainty about what to change</li>
      <li>Belief that one resume should work for all jobs</li>
    </ul>
  </div>
  ...
  <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6">
    ...
    <ul class="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
      ...
      <li>Tailor your experience descriptions to match the role</li>
      <li>Customize your summary/objective for each position</li>
    </ul>
  </div>
</div>
...
<div class="mb-12">
  ...
  <div class="grid md:grid-cols-2 gap-6">
    <div class="bg-red-50 dark:bg-red-900/20 rounded-lg p-6">
      <h3 class="text-xl font-semibold text-red-800 dark:text-red-200 mb-4">Examples of Weak Verbs:</h3>
      <ul class="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
    ...
    <div class="bg-green-50 dark:bg-green-900/20 rounded-lg p-6">
      <h3 class="text-xl font-semibold text-green-800 dark:text-green-200 mb-4">Strong Action Verbs to Use Instead:</h3>
      <ul class="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
        <li>Led, Managed, Directed</li>
        <li>Developed, Created, Implemented</li>
        <li>Increased, Improved, Enhanced</li>
        <li>Achieved, Accomplished, Delivered</li>
      </ul>
    </div>
  </div>
</div>
...
<div class="mb-12">
  ...
  <div class="grid md:grid-cols-2 gap-6">
    <div class="bg-red-50 dark:bg-red-900/20 rounded-lg p-6">
      <h3 class="text-xl font-semibold text-red-800 dark:text-red-200 mb-4">Before (Weak):</h3>
      <p class="text-gray-700 dark:text-gray-300 italic">"Responsible for managing social media accounts"</p>
    </div>

    <div class="bg-green-50 dark:bg-green-900/20 rounded-lg p-6">
      <h3 class="text-xl font-semibold text-green-800 dark:text-green-200 mb-4">After (Strong):</h3>
      <p class="text-gray-700 dark:text-gray-300 italic">"Increased social media engagement by 45% and grew follower base by 2,000+ users through strategic content planning and community management"</p>
    </div>
  </div>
</div>
...
<div class="mb-12">
  ...
  <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
    ...
    <ul class="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
      ...
      <li>Too much or too little white space</li>
    </ul>
  </div>
</div>
...
<div class="mb-12">
  ...
  <div class="bg-red-50 dark:bg-red-900/20 rounded-lg p-6">
    ...
    <ul class="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
      <li>High school information (if you have a college degree)</li>
      <li>Jobs from 10+ years ago (unless highly relevant)</li>
      <li>Personal information (age, marital status, etc.)</li>
      <li>Generic skills that everyone has</li>
    </ul>
  </div>
</div>
...
<div class="mb-12">
  ...
  <div class="bg-yellow-50 dark:bg-yellow-900/20 rounded-lg p-6">
    ...
    <ul class="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
      <li>Homophones (their/there/they're, your/you're)</li>
      <li>Inconsistent capitalization</li>
      <li>Missing or incorrect punctuation</li>
...
<div class="mb-12">
  ...
  <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6">
    ...
    <ul class="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
      <li>Analyze the job description for repeated terms</li>
...
<div class="mb-12">
  ...
  <div class="bg-green-50 dark:bg-green-900/20 rounded-lg p-6">
    ...
    <ul class="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
      ...
      <li><strong>Senior/Executive:</strong> 2-3 pages</li>
    </ul>
  </div>
</div>
...
<div class="mb-12">
  ...
  <div class="bg-yellow-50 dark:bg-yellow-900/20 rounded-lg p-6">
    ...
    <ul class="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
      ...
      <li>Verify all contact information is correct</li>
